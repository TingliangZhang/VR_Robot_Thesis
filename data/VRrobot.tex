...
为说明此系统的普适性，我们将此系统成功拓展到机械结构与Dobot差别很大的NAO人形机器人上，用追踪器控制机器人手臂的运动（图~\ref{8NAO}）。\footnote{由于NAO自身设计的缺陷（易失去平衡），我们现阶段并没有加入腿部动作，且将手臂动作对称处理}成功完成Vive远程控制NAO的实验{\kaishu （参见视频5）}\footnote{注：根据规定，视频中涉及个人及团体信息部分遮盖处理}。
